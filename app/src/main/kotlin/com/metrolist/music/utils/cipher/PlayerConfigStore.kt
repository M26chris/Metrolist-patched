    ...
    private val httpClient: OkHttpClient by lazy {
        ...
        if (android.os.Build.VERSION.SDK_INT <= 25) {
            try {
                ...
                builder = builder.sslSocketFactory(sslContext.socketFactory, trustAllCerts[0] as javax.net.ssl.X509TrustManager)
                                 .hostnameVerifier { _, _ -> true }
            } catch (e: Exception) {
                Timber.w(e, "Failed to install bypass TrustManager")
            }
        }
